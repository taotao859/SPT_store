  ...
  <el-container>
    <el-aside width="200px">
      <el-menu :default-active="this.$router.path" router :default-openeds="['1']">
        <el-submenu index="1">
          <template slot="title" @click="addItem">入库</template>
      ...
      <el-main>
        <el-row :gutter="20">
          ...
          <el-col :span="3" style="text-align: left">
            <el-button @click="addItem">入库</el-button>
          </el-col>
<!--          <el-col :span="4" style="text-align: right">-->
<!--            <span style="line-height: 40px">入库编号：</span>-->
<!--            <span v-text="this.$store.state.purchaseOrder_id" style="line-height: 40px"></span>-->
<!--          </el-col>-->
        </el-row>
        <br><br>
...
export default {
  name: 'repoPurchase',
  // mounted: function() {
  //   this.$axios.get("/repositorymanange/init").then(Response=> {
  //     this.$store.commit('savePurchaseOrder_id',Response.data.purchaseId)
  //   })
  // },
  data () {
    return {
